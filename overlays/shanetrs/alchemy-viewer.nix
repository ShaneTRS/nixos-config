...
in
  stdenvNoCC.mkDerivation rec {
    ...
    sourceRoot = ".";
    installPhase = ''
      mkdir -p $out/bin $out/opt/alchemy
      ...
      install -D $out/opt/alchemy/alchemy_icon.png $out/share/icons/hicolor/256x256/apps/${pname}.png
      makeWrapper ${getExe fhs} $out/bin/${meta.mainProgram} \
